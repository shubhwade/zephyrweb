...
const EVENT_DETAILS = {
  ...
  'BGMI (Classic)': { prizePool: 'Not listed', priceDisplay: 'Not listed', teamDisplay: 'Individual' },
...
export const MASTER_EVENTS = [
  ...
  {eventName:'Fall Guys',committees:['TRS'],category:'Creative',image:'/wordmark/skribbl.jpg',imageAlt:'Colorful digital drawing and guessing game setup',description:'A fast sketch-and-guess challenge powered by creativity and reaction time.',isShared:false},
  ...
  {eventName:'Human Foosball',committees:['S4DS'],category:'Sports',image:'/wordmark/clay art.jpg',imageAlt:'Human foosball players competing in a team arena',description:'A fast-paced team challenge built around coordination and movement.',isShared:false},
  ...
  {eventName:'AR-VR Space Blitz',committees:['IOT'],category:'Tech',image:'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&w=1200&q=80',imageAlt:'Immersive AR-VR space battlefield with headset and futuristic visuals',description:'A space-themed immersive challenge combining VR and AR action.',isShared:false},
  ...
  {eventName:'Spin the Wheel',committees:['ASME'],category:'Puzzle / Experience',image:'https://images.unsplash.com/photo-1517649763962-0c623066013b?auto=format&fit=crop&w=1200&q=80',imageAlt:'Prize wheel spinning in a carnival-style event',description:'A suspenseful spin-to-win moment built around rewards and crowd energy.',isShared:false},
  ...
  {eventName:'Cyber Heist',committees:['ACM'],category:'Tech',image:'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1200&q=80',imageAlt:'Cybersecurity challenge on a computer workstation',description:'A technical heist challenge focused on cybersecurity and problem solving.',isShared:false},
